package com.hucet.gateway.user_service.controller;


import com.hucet.gateway.user_service.domain.Account;
import com.hucet.gateway.user_service.dto.AccountDto;
import com.hucet.gateway.user_service.service.AccountService;
...
public class UserController {
    ...
    Account getUser(@PathVariable("userName") String userName) {
